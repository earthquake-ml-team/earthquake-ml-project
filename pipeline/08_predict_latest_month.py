...
DATA = BASE / "data/processed/ml_final_dataset.csv"
PROB_MODEL = BASE / "models/xgb_prob.pkl"
FEAT_INFO = BASE / "models/feature_info.pkl"
CLASS_MODEL = BASE / "models/xgb_class.pkl"
CLASS_INFO = BASE / "models/class_info.pkl"

OUT = BASE / "outputs/predictions_latest_month.csv"
